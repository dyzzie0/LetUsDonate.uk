        ...
        <div className="dashboard-left">
          <div className="dashboard">
            <aside className="links">
              <ul>
                <li><ii className="fa-solid fa-gauge"></ii><a href="/my_impact">My Impact</a></li>
                <li><ii className="fa-solid fa-inbox"></ii><a href="/my_donations">My Donations</a></li>
                <li><ii className="fa-solid fa-user"></ii><a href="/my_profile">My Profile</a></li>
                <li>
          ...
          <form className="new-donation" onSubmit={handleSubmit}>
            ...
            {file && (
              <div className="file-preview">
                ...
                {preview && ( <div className="image-preview"> <img
        src={preview} alt="Preview"
            onClick={() => setModalOpen(true)}
            className="thumbnail" required
          />
                    <p>

<button type="button" onClick={handleDeleteFile} className="remove-btn">Remove</button>
</p>
